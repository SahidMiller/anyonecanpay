...
const iconList = {
  twitter: {
    ...
    color: "#1DA1F2",
    getUrl: (l, t) => (`https://twitter.com/intent/tweet?text=${t}&url=${l}`),
    displayName: "Twitter"
  },
  whatsapp: {
    path: (
    ...
    color: "#25D366",
    getUrl: (l, t) => {
      const template = `Hi,\n\nI'd really appreciate it if you would share or donate to this Flipstarter.\n\n*${t}*\n\n${t}…\n\nRead more here ${l}\n\nForward this message to your contacts to help this campaign reach its goal!`
      return`https://web.whatsapp.com/send?text=${encodeURIComponent(template)}`
    },
  ...
  reddit: {
    ...
    color: "#FF4500",
    getUrl: (l, t) => (`https://www.reddit.com/submit?url=${l}&title=${t}`),
    displayName: "Reddit"
  },
  telegram: {
    path: (
    ...
    color: "#0088CC",
    getUrl: (l, t) => (`https://telegram.me/share/msg?url=${l}&text=${t}`),
  ...
  mail: {
    ...
    color: "#E53E3E",
    getUrl: (l, t) => (`mailto:?body=${l}&subject=${t}`),
    displayName: "Email"
  },
  share: (window.navigator.share) ? {
    ...
    color: "#718096",
    getUrl: () => ("#"),
    onClick: (shareData) => navigator.clipboard.writeText(shareData.url),
